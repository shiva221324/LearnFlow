      ...
      <div className="relative mx-auto flex flex-col w-11/12 max-w-maxContent items-center text-white justify-between gap-8">
        ...
        <div>
          <CodeBlocks
            ...
            subheading={
              "Our coding contests are crafted and curated by seasoned industry experts with years of coding experience. They are dedicated to sharing their expertise and passion for coding with you."
            }
            ctabtn1={{
